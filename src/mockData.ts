...
export const estimateItems: EstimateItem[] = [
  // Project 1
  { id: 1, projectId: 1, category: 'Демонтаж', workName: 'Снос перегородок', unit: 'м?', quantity: 25, unitPrice: 900, total: 22500 },
  { id: 2, projectId: 1, category: 'Черновые работы', workName: 'Стяжка пола', unit: 'м?', quantity: 70, unitPrice: 1200, total: 84000 },
  { id: 3, projectId: 1, category: 'Электрика', workName: 'Разводка по комнатам', unit: 'точка', quantity: 45, unitPrice: 950, total: 42750 },
  ...
  { id: 8, projectId: 2, category: 'Черновые работы', workName: 'Подготовка стен под стекло', unit: 'м?', quantity: 200, unitPrice: 1050, total: 210000 },
  { id: 9, projectId: 2, category: 'Электрика', workName: 'Слаботочка и Wi?Fi', unit: 'точка', quantity: 90, unitPrice: 1150, total: 103500 },
  ...
  { id: 15, projectId: 3, category: 'Электрика', workName: 'Щит и ввод', unit: 'компл.', quantity: 1, unitPrice: 210000, total: 210000 },
  { id: 16, projectId: 3, category: 'Отделка', workName: 'Фасадные панели', unit: 'м?', quantity: 180, unitPrice: 3200, total: 576000 },
